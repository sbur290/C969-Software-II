        ...
        private void OnSaveButtonPressed(object sender, EventArgs e) {
            ...
            try {
                ...
                foreach(var appt in userAppointments) {
                    ...
                    if((apptStart >= proposedStart && apptStart <= proposedEnd) // if appointment start is within range of proposed appointment
                        || (apptEnd >= proposedStart && apptEnd <= proposedEnd) // if appointment end is within range of proposed appointment
                        || (proposedStart >= apptStart && proposedStart <= apptEnd)// if proposed appointment start is within range of appointment
